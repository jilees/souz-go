...
// TestChatSmoke hits the real OpenAI API. Skipped unless OPENAI_API_KEY is set.
...
// TestChatStreamSmoke hits the real OpenAI API with streaming. Skipped unless OPENAI_API_KEY is set.
